...
const AppSection = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-5 px-28 justify-center items-center">
      ...
      <div className="flex-1 lg:text-left text-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 text-xl mt-10">

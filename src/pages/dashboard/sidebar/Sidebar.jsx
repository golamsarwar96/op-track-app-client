...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 min-h-screen bg-primaryColor px-3">
      <Link to="/" className="flex justify-center items-center gap-1 p-5">
        <h2 className="self-center whitespace-nowrap lg:text-3xl text-2xl text-white font-extrabold dark:text-white">
          Op<span className="text-darkMode">Track</span>
        </h2>
        <img className="md:w-10 md:h-10 w-9 h-9" src={logoIcon} />
      </Link>
      <div className="flex flex-col items-center justify-center">
        <div className="lg:text-2xl md:text-xl text-lg bg-darkMode font-semibold text-white mb-5 px-4 py-1">
          {role}
        </div>
